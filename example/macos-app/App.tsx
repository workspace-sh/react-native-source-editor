...
`,
  javascript: `// Edit on the left; preview shows captured console output.
...
export default function App() {
  ...
  const previewHTML = useMemo(() => {
    ...
    // json / plaintext — just render as monospace
...
<style>
  ...
  blockquote { border-left: 3px solid ${isDark ? '#3a3a3c' : '#d1d1d6'}; padding-left: 12px; margin-left: 0; color: ${isDark ? '#a1a1a6' : '#6e6e73'}; }
</style>
...
<html><head>
<style>
  body { font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 13px; padding: 16px;
...
<style>
  body {
    font-family: ui-monospace, SFMono-Regular, Menlo, monospace;
    font-size: 13px; line-height: 1.5; padding: 16px; margin: 0;
    background: ${isDark ? '#000' : '#fff'};
    color: ${isDark ? '#f2f2f7' : '#1d1d1f'};
  }
